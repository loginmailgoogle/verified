...
function HomePage() {
  ...
  return (
    <section className='glavni'>
        <section className="sectionOne" style = {erevaVer ? { display: 'none' } : { display: 'flex' } }>
        ...
        <section className="sectionTwo" style = {erevaVer ? { display: 'flex' } : { display: 'none' } }>
            <div className='bigv'>
                <div className='v'>
                    <img src={logoSvg} alt="logo" className="logo" id="mainlogo" />
                </div>
